...
function getDocIdBound(index, numBatches) {
  ...
  return "tbl_users/" + firstChar + secondChar;
}
...
const kStripeTestSecretKey =
  "sk_test_51QSIkIFqSsPS6Wq6i7W6t7JR3EMsYn4KqPSnrj3OHZIPcQ0McXmwiEsy6ZXAgTOqTKTeQ0lHSdp5SzsNC8gN7Epq00m1qPd8K5";
...
const kTokenId = "b33c81f6-0460-4722-8150-b2e2d4df71b1";
const kTokenSecret =
  "TDXu7QQcDZRt1pMWZZbVvn9QSPmjPyF53lfyU1hBveLC5sW/JoG+kIOebAFrePxkukwEsV/L/22";
...
exports.onUserDeleted = functions.auth.user().onDelete(async (user) => {
  ...
  let userRef = firestore.doc("tbl_users/" + user.uid);
});
