...
DocumentReference? get currentUserReference =>
    loggedIn ? TblUsersRecord.collection.doc(currentUser!.uid) : null;

TblUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : TblUsersRecord.getDocument(TblUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
