...
import 'users_events_list_component_model.dart';
export 'users_events_list_component_model.dart';

class UsersEventsListComponentWidget extends StatefulWidget {
  const UsersEventsListComponentWidget({
    super.key,
  ...
  @override
  State<UsersEventsListComponentWidget> createState() =>
      _UsersEventsListComponentWidgetState();
}

class _UsersEventsListComponentWidgetState
    extends State<UsersEventsListComponentWidget>
    with TickerProviderStateMixin {
  late UsersEventsListComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UsersEventsListComponentModel());
                        ...
                        child: StreamBuilder<List<TblEventImagesRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final meetupImageTblEventImagesRecord =
                                meetupImageTblEventImagesRecordList.isNotEmpty
                                    ? meetupImageTblEventImagesRecordList.first
                                    : null;
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: Image.network(
                                    meetupImageTblEventImagesRecord!.imagePath,
                                  ).image,
                                ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  '${dateTimeFormat(
                                    "d",
                                    eventsListViewTblEventsRecord.startTime,
                                ...
                                Text(
                                  eventsListViewTblEventsRecord.locationName
                                      .maybeHandleOverflow(
                                    maxChars: 10,
                                    replacement: '…',
                                  ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'USERS_EVENTS_LIST_COMPONENT_Container_19');
