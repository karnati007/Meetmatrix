...
import 'events_list_component_model.dart';
export 'events_list_component_model.dart';

class EventsListComponentWidget extends StatefulWidget {
  const EventsListComponentWidget({
    super.key,
  ...
  @override
  State<EventsListComponentWidget> createState() =>
      _EventsListComponentWidgetState();
}

class _EventsListComponentWidgetState extends State<EventsListComponentWidget>
    with TickerProviderStateMixin {
  late EventsListComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventsListComponentModel());
            ...
            itemBuilder: (context, eventsListViewIndex) {
              ...
              return FutureBuilder<int>(
                future: queryTblTicketsRecordCount(
                  queryBuilder: (tblTicketsRecord) => tblTicketsRecord
                      .where(
                        'event_id',
                ...
                builder: (context, snapshot) {
                  ...
                  return InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'EVENTS_LIST_COMPONENT_BottomContainer_ON');
                                ...
                                builder: (context) {
                                  if (bottomContainerCount > 0) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EVENTS_LIST_COMPONENT_Container_xhd1uzp2');
                                        logFirebaseEvent(
