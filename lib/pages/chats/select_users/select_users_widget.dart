...
import '/pages/chats/components/empty_state_simple/empty_state_simple_widget.dart';
...
import 'select_users_model.dart';
export 'select_users_model.dart';
...
class _SelectUsersWidgetState extends State<SelectUsersWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectUsersModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'SelectUsers'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('SELECT_USERS_SelectUsers_ON_INIT_STATE');
      if (widget.chatRef != null) {
        // addChatUsers_ToList
        logFirebaseEvent('SelectUsers_addChatUsers_ToList');
        _model.friendsList =
            widget.chatRef!.users.toList().cast<DocumentReference>();
        safeSetState(() {});
      } else {
        // addUser_ToList
        logFirebaseEvent('SelectUsers_addUser_ToList');
          ...
          title: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'm2nmjd6f' /* Select users from below to sta... */,
                  ),
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('SELECT_USERS_close_rounded_ICN_ON_TAP');
                  ...
                  child: Padding(
                    ...
                    child: PagedListView<DocumentSnapshot<Object?>?,
                      ...
                      pagingController: _model.setListViewController(
                        TblUsersRecord.collection.orderBy('display_name'),
                      ),
                      ...
                      builderDelegate:
                          PagedChildBuilderDelegate<TblUsersRecord>(
                        ...
                        itemBuilder: (context, _, listViewIndex) {
                          final listViewTblUsersRecord = _model
                              .listViewPagingController!
                              .itemList![listViewIndex];
                          return Visibility(
                            visible: listViewTblUsersRecord.reference !=
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _model.friendsList.contains(
                                          listViewTblUsersRecord.reference)
                                        ...
                                        child: Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              fadeOutDuration:
                                                  const Duration(milliseconds: 200),
                                              imageUrl: listViewTblUsersRecord
                                                  .photoUrl,
                                              width: 44.0,
                                              height: 44.0,
                                              fit: BoxFit.cover,
                                        ...
                                        child: Theme(
                                          ...
                                          child: CheckboxListTile(
                                            ...
                                            onChanged: (newValue) async {
                                              ...
                                              if (newValue!) {
                                                logFirebaseEvent(
                                                    'SELECT_USERS_CheckboxListTile_i2hqvffk_O');
                                                // addUser
                                                logFirebaseEvent(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'SELECT_USERS_PAGE_Button_dw2e19yy_ON_TAP');
                    ...
                    text: widget.chatRef != null ? 'Add to Chat' : 'New Chat',
