...
import '/pages/chats/components/chat_details_overlay/chat_details_overlay_widget.dart';
import '/pages/chats/components/chat_thread_component/chat_thread_component_widget.dart';
import 'dart:async';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FutureBuilder<TblUsersRecord>(
            future: TblUsersRecord.getDocumentOnce(widget.chatRef!.users
            ...
            builder: (context, snapshot) {
              ...
              final conditionalBuilderTblUsersRecord = snapshot.data!;
                ...
                builder: (context) {
                  if (widget.chatRef!.users.length <= 2) {
                    return Row(
                      ...
                      children: [
                        if (conditionalBuilderTblUsersRecord.photoUrl != '')
                          Align(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      conditionalBuilderTblUsersRecord.photoUrl,
                                      width: 44.0,
                                      height: 44.0,
                                      fit: BoxFit.cover,
                                    ),
                            ...
                            children: [
                              Text(
                                valueOrDefault<String>(
                                  conditionalBuilderTblUsersRecord.displayName,
                                  'Ghost User',
                                ),
                              ...
                              Padding(
                                ...
                                child: AutoSizeText(
                                  valueOrDefault<String>(
                                    conditionalBuilderTblUsersRecord.email,
                                    'casper@ghost.io',
                                  ).maybeHandleOverflow(
                                    maxChars: 40,
                                    replacement: '…',
                          ...
                          child: SizedBox(
                            ...
                            child: Stack(
                              children: [
                                Align(
                                  alignment: const AlignmentDirectional(1.0, 1.0),
                                  child: FutureBuilder<TblUsersRecord>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final secondUserTblUsersRecord =
                                          snapshot.data!;
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            conditionalBuilderTblUsersRecord
                                                .photoUrl,
                                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/teams/GzvajSxrHvi1zwJQsfLk/assets/tjm1k7ywi5dr/@3xlogoMark_outlineOnWhite.png',
                                          ),
                                          width: 44.0,
