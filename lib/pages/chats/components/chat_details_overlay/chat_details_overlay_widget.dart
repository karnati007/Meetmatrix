...
import '/pages/chats/components/delete_dialog/delete_dialog_widget.dart';
import '/pages/chats/components/user_list_small/user_list_small_widget.dart';
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, chatUsersIndex) {
                          ...
                          return FutureBuilder<TblUsersRecord>(
                            future:
                                TblUsersRecord.getDocumentOnce(chatUsersItem),
                            builder: (context, snapshot) {
                              ...
                              final userListSmallTblUsersRecord =
                                  snapshot.data!;
                              ...
                              return wrapWithModel(
                                ...
                                child: UserListSmallWidget(
                                  key: Key(
                                    'Keykg1_${chatUsersItem.id}',
                                  ),
                                  userRef: userListSmallTblUsersRecord,
                                  action: () async {},
                                ),
                              );
                            },
                    ...
                    Expanded(
                      child: wrapWithModel(
                        ...
                        child: DeleteDialogWidget(
                          ...
                          action: () async {
                            logFirebaseEvent(
                                'CHAT_DETAILS_OVERLAY_Container_miu0ar52_');
                            logFirebaseEvent(
