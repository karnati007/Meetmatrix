...
import '/pages/chats/components/chat_thread/chat_thread_widget.dart';
              ...
              stream: queryChatMessagesRecord(
                ...
                limit: 200,
                  ...
                  if (_model.listViewPreviousSnapshot != null &&
                    ...
                    () async {
                      logFirebaseEvent(
                          'CHAT_THREAD_COMPONENT_ListView_0ku3eopy_');
                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadWidget(
                          key: Key(
                            'Key87z_${listViewChatMessagesRecord.reference.id}',
                          ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      logFirebaseEvent(
                                          'CHAT_THREAD_COMPONENT_TextField_bbja93l9');
                                      logFirebaseEvent(
