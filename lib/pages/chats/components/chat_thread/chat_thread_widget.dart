              ...
              child: Padding(
                ...
                child: FutureBuilder<TblUsersRecord>(
                  future: _model.chatUser(
                    ...
                    requestFn: () => TblUsersRecord.getDocumentOnce(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final otherUserTblUsersRecord = snapshot.data!;
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl: otherUserTblUsersRecord.photoUrl,
                                  width: 44.0,
                                  height: 44.0,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    SelectionArea(
                                        child: AutoSizeText(
                                      otherUserTblUsersRecord.displayName,
                                ...
                                if (widget.chatMessagesRef?.image != null &&
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CHAT_THREAD_MediaDisplay_zi0t42z1_ON_TAP');
                                        logFirebaseEvent(
                            ...
                            if (widget.chatMessagesRef?.image != null &&
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CHAT_THREAD_MediaDisplay_3iyar1mc_ON_TAP');
                                    logFirebaseEvent(
                                        'MediaDisplay_navigate_to');
